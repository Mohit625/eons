...
// Renders a horizontal tournament bracket with columns flowing left-to-right.
// Supports optional onScoreChange for editable scores and colOffset for correct
// match labeling when rendering a subset of columns.
