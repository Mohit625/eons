// src/components/leaderboards/LeaderboardCodm.jsx
...
// Removed: type { Bracket, Game } import

// Removed: CODM-Specific Types
const CODM_MATCH_KEYS = ["match1", "match2", "match3"]; // Removed: as const
// Removed: CodmMatchKey type
// Removed: CodmMatchStats type
// Removed: CodmRow type

// CODM-Specific Logic
const createEmptyCodmMatch = () => ({ wins: 0, placement: 0, kills: 0, points: 0 }); // Removed: : CodmMatchStats
const createEmptyCodmMatches = () => ({ // Removed: : Record<CodmMatchKey, CodmMatchStats>
  match1: createEmptyCodmMatch(),
  match2: createEmptyCodmMatch(),
  match3: createEmptyCodmMatch(),
});

// Removed: LeaderboardCodmProps type
