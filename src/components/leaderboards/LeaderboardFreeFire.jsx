              ...
              <CardContent>
                <div className="overflow-x-auto">
                  <Tabs defaultValue="overall">
                    ...
                    <TabsContent value="match2">
                      {/* ... Semifinals Match 2 Table ... */}
                    </TabsContent>
                    <TabsContent value="match3">
                      {/* ... Semifinals Match 3 Table ... */}
                    </TabsContent>
                  </Tabs>
                </div>
              </CardContent>
